            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg my-1">
                <div class="p-6 text-gray-900">
                    <div class="d-flex" style="justify-content: space-between">
                        ...
                        <div>
                            <a href="{{ route('webhook.create', $webhookBucket->id) }}" class="btn btn-primary ">
                                create new input <i class="fa fa-plus"></i>
                            </a>
                            <button type="button" class="btn btn-warning "
                                onclick="editBucketBtn({{ $webhookBucket }})" style="cursor:pointer" data-toggle="modal"
                                data-target="#editBucket" id="edit-bucket-btn">
                                edit bucket <i class="fa fa-pen"></i>
                            </button>
                            <form class="d-inline" action="{{ route('webhook-buckets.destroy', $webhookBucket->id) }}"
                    ...
                    <details class="bg-gray-300 open:bg-amber-200 duration-300 my-1 mb-2">
                        ...
                        <div class="bg-white px-5 py-3 border border-gray-300 text-sm font-light">
                            <div class="mb-2">
                                ...
                                <input type="text" disabled value="{{ $webhook->endpoint }}" class="form-control" />
                            </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row m-1" style="height: 120px; text-align:center; display:flex; justify-content:center;">
                                                ...
                                                <div class="col-md-2 pt-5"
                                                    style="border-radius:5px; background:#90EE90; margin-right: 1rem">
                                                    <p class="mb-4" style="font-size:35px">0</p>
                                                    <p>Success</p>
                                                </div>
                                                <div class="col-md-2 pt-5"
                                                    style="border-radius:5px; background:#FF474C; margin-right: 1rem">
                                                    <p class="mb-4" style="font-size:35px">0</p>
                                                    <p>Failed</p>
                                                </div>
                                                <div class="col-md-2 pt-5"
                                                    style="border-radius:5px; background:#7c8184; margin-right: 1rem">
                                                    <p class="mb-4" style="font-size:35px">0</p>
                                                    <p>Queued</p>
                                                </div>
                                                <div class="col-md-2 pt-5"
                                                    style="border-radius:5px; background:#FFFFED; margin-right: 1rem">
                                                    <p class="mb-4" style="font-size:35px">0</p>
                                                    <p>Pending</p>
                                                </div>
                                                <div class=" col-md-2 pt-5"
                                                    style="border-radius:5px; background:#3e5c74; margin-right: 1rem">
                                                    <p class="mb-4" style="font-size:35px">0</p>
                                                    <p>Filtered</p>
                                                </div>
                                            </div>
                            ...
                            @else
                                <div class="border mt-3" style="border-radius:5px">
                                    <p class="bg-info m-2 text-center text-white p-3" style="font-size: 13px;"> Heads
